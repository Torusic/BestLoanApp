       ...
       <section className=''>
           <div className='w-full grid bg-gray-700  max-w-4xl lg:max-w-7xl lg:w-full md:max-w-5xl md:w-full rounded-lg '>
              ...
              <div className='bg-gray-900 p-2 rounded-lg '>
                    <div className='flex items-center justify-between'>
                     ...
                     <div className='my-4 flex justify-center items-center w-fit ml-auto'>
                            ...
                            <Link to={"/clientStats/apply"}>Apply Loan</Link>
                                  ...
                                  {!active ?(
                   <div className='text-gray-200 flex font-semibold rounded-lg bg-gray-700 text-xs p-2 lg:text-sm font-normal  items-center justify-center'>
                    No Loan
                   </div>
                   ...
                   <div className='bg-gray-900 text-white p-2 my-4 rounded-lg text-xs lg:text-sm md:text-sm grid gap-2'>
